...
function Header(){
  ...
  const handleClose=()=>{
    ...
    return <div className="bg-orange-500 h-[990px]">
    <div className="bg-orange-500  p-5  text-black flex justify-between">
...
<div className="sm:flex-col">
  ...
  <button className="bg-white px-20 py-4 ml-28  text-3xl mt-4 rounded">Explore More</button>
</div>
...
<div className="sm:flex bg-orange-50 mt-10 py-14">
...
<div className="bg-white mt-10 w-[400px] h-[250px] ml-20 rounded shadow-lg ">
<i class=" text-8xl pl-40 pt-4 fa-solid fa-mobile"></i>
<div className="pl-20">
<h1 className="font-bold  text-2xl">Software developmebnt</h1>
<p>Tell us what you like and we'll show your top <br />
  job opportunities</p>
